            ...
            <div class="dashboard-nav">
                <div class="dashboard-inner">
                    <ul data-submenu-title="Main Navigation">
                        ...
                        <li><a href="dashboard-manage-resume.html"><i class="lni lni-files mr-2"></i>Manage
                                Resumes</a></li>
                        ...
                        <li><a href="dashboard-saved-jobs.html"><i class="lni lni-bookmark mr-2"></i>Bookmark
                                Jobs</a></li>

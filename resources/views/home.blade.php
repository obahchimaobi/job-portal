...
@section('content')
    <!-- ======================= Home Banner ======================== -->
    <div class="home-banner margin-bottom-0" style="background:#28b661 url(https://via.placeholder.com/1920x900) no-repeat;"
        data-overlay="4">
        <div class="container">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <div class="job_grid border rounded ">
                        ...
                        <div class="job_grid_thumb mb-2 pt-5 px-3">
                            <a href="{{ url('job-detail.html') }}" class="d-block text-center m-auto"><img
                                    src="{{ url('https://via.placeholder.com/120x120') }}" class="img-fluid" width="70"
                                    alt="" /></a>
                        </div>
                        <div class="job_grid_caption text-center pb-3 px-3">
                            <h4 class="mb-0 ft-medium medium"><a href="{{ url('job-detail.html') }}" class="text-dark fs-md">UI/UX Web
                                    Designer</a></h4>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="position-relative text-center">
                        <a href="{{ url('job-search-v1.html') }}" class="btn btn-md theme-bg rounded text-white hover-theme">Explore
    ...
    <section class="space gray">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="cats-wrap text-center">
                        <a href="{{ url('job-search-v1.html') }}" class="cats-box d-block rounded bg-white px-2 py-4">
                            <div
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="cats-wrap text-center">
                        <a href="{{ url('job-search-v1.html') }}" class="cats-box d-block rounded bg-white px-2 py-4">
                            <div
                                class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                <i class="lni lni-cloud fs-lg theme-cl"></i>
                            </div>
                            <div class="cats-box-caption">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="cats-wrap text-center">
                        <a href="{{ url('job-search-v1.html') }}" class="cats-box d-block rounded bg-white px-2 py-4">
                            <div
                                class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                <i class="lni lni-shopify fs-lg theme-cl"></i>
                            </div>
                            <div class="cats-box-caption">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="cats-wrap text-center">
                        <a href="{{ url('job-search-v1.html') }}" class="cats-box d-block rounded bg-white px-2 py-4">
                            <div
                                class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                <i class="lni lni-construction fs-lg theme-cl"></i>
                            </div>
                            <div class="cats-box-caption">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="cats-wrap text-center">
                        <a href="{{ url('job-search-v1.html') }}" class="cats-box d-block rounded bg-white px-2 py-4">
                            <div
                                class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                <i class="lni lni-phone-set fs-lg theme-cl"></i>
                            </div>
                            <div class="cats-box-caption">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="cats-wrap text-center">
                        <a href="{{ url('job-search-v1.html') }}" class="cats-box d-block rounded bg-white px-2 py-4">
                            <div
                                class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                <i class="lni lni-sthethoscope fs-lg theme-cl"></i>
                            </div>
                            <div class="cats-box-caption">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="cats-wrap text-center">
                        <a href="{{ url('job-search-v1.html') }}" class="cats-box d-block rounded bg-white px-2 py-4">
                            <div
                                class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                <i class="lni lni-money-protection fs-lg theme-cl"></i>
                            </div>
                            <div class="cats-box-caption">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="cats-wrap text-center">
                        <a href="{{ url('job-search-v1.html') }}" class="cats-box d-block rounded bg-white px-2 py-4">
                            <div
                                class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                <i class="lni lni-diamond fs-lg theme-cl"></i>
                            </div>
                            <div class="cats-box-caption">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="cats-wrap text-center">
                        <a href="{{ url('job-search-v1.html') }}" class="cats-box d-block rounded bg-white px-2 py-4">
                            <div
                                class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                <i class="lni lni-graduation fs-lg theme-cl"></i>
                            </div>
                            <div class="cats-box-caption">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="cats-wrap text-center">
                        <a href="{{ url('job-search-v1.html') }}" class="cats-box d-block rounded bg-white px-2 py-4">
                            <div
                                class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                <i class="lni lni-mastercard fs-lg theme-cl"></i>
                            </div>
                            <div class="cats-box-caption">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="position-relative text-center">
                        <a href="{{ url('browse-category.html') }}" class="btn btn-md bg-dark rounded text-light hover-theme">Browse
                            All Categories<i class="lni lni-arrow-right-circle ml-2"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="m-spaced">
                        <div class="position-relative">
                            <div class="mb-1"><span class="theme-bg-light theme-cl px-2 py-1 rounded">About
                                    Us</span></div>
                ...
                <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                    <div class="position-relative">
                        <img src="{{ url('https://via.placeholder.com/900x1000') }}" class="img-fluid" alt="" />
                    </div>
                </div>
            </div>
                    ...
                    <div class="m-spaced">
                        ...
                        <div class="position-relative row">
                            ...
                            <div class="col-lg-12 col-md-12 col-12 mt-4">
                                <a href="{{ url('javascript:void(0);') }}"
                                    class="btn btn-md theme-bg rounded text-white hover-theme">Get Started<i
                                        class="lni lni-arrow-right-circle ml-2"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="empl-thumb text-center px-3 py-4">
                        <img src="{{ url('https://via.placeholder.com/300x80') }}" class="img-fluid mx-auto" alt="" />
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="blg_grid_box">
                        <div class="blg_grid_thumb">
                            <a href="{{ url('blog-detail.html') }}"><img src="{{ url('https://via.placeholder.com/1200x800') }}" class="img-fluid"
                                    alt=""></a>
                        </div>
                        <div class="blg_grid_caption">
                            <div class="blg_tag"><span>Marketing</span></div>
                            <div class="blg_title">
                                <h4><a href="{{ url('blog-detail.html') }}">How To Register &amp; Enrolled on SkillUp Step by
                                        Step?</a></h4>
                            </div>
                            <div class="blg_desc">
                        ...
                        <div class="crs_grid_foot">
                            <div class="crs_flex d-flex align-items-center justify-content-between br-top px-3 py-2">
                                <div class="crs_fl_first">
                                    <div class="crs_tutor">
                                        <div class="crs_tutor_thumb"><a href="{{ url('instructor-detail.html') }}"><img
                                                    src="{{ url('https://via.placeholder.com/500x500') }}" class="img-fluid circle"
                                                    width="35" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="blg_grid_box">
                        ...
                        <div class="blg_grid_caption">
                            ...
                            <div class="blg_title">
                                <h4><a href="{{ url('blog-detail.html') }}">Let's Know How Skillup Work Fast and Secure?</a>
                                </h4>
                            </div>
                            <div class="blg_desc">
                                <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="blg_grid_box">
                        ...
                        <div class="blg_grid_caption">
                            ...
                            <div class="blg_title">
                                <h4><a href="{{ url('blog-detail.html') }}">How To Improove Digital Marketing for Fast SEO</a>
                                </h4>
                            </div>
                            <div class="blg_desc">
                                <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
